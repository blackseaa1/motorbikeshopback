            ...
            <div class="col-lg-5">
                <div class="card shadow-sm" style="top: 20px;">
                    <div class="card-body p-4">
                        ...
                        {{-- === PHẦN SỬA ĐỔI: THÊM ẢNH SẢN PHẨM VÀO DANH SÁCH === --}}
                        ...
                        <hr>
                        {{-- Chọn đơn vị vận chuyển với bootstrap-select --}}
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <button class="btn btn-outline-secondary" type="button" id="apply-promo-btn">Áp
                                    dụng</button>
                                @if(!empty($cartDetails['promotion_info']['code']))
                                    <button class="btn btn-outline-danger" type="button" id="remove-promo-btn">Xóa</button>
                                @endif
                            </div>
