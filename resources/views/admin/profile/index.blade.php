...
@section('content')
    ...
    <div id="profilePageData"
        data-has-password-errors="{{ ($errors->has('current_password', 'changePassword') || $errors->has('new_password', 'changePassword')) ? 'true' : 'false' }}"
                    ...
                    <div class="card card-primary card-outline card-profile-avatar">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <form id="avatarUpdateForm" action="{{ route('admin.profile.updateAvatar') }}" method="POST"
                            ...
                            {{-- THAY ĐỔI Ở ĐÂY: Bọc vai trò trong span với class --}}
                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-tabs profile-tabs" id="profileTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="settings-tab-link" data-bs-toggle="tab" href="#settings"
                                        role="tab" aria-controls="settings" aria-selected="true">Cập nhật Thông tin</a>
                                </li>
                                <li class="nav-item" role="presentation">
                            ...
                            <div class="tab-content pt-3" id="profileTabContent">
                                    ...
                                    <form class="form-horizontal" action="{{ route('admin.profile.updateInfo') }}"
                                        ...
                                        <div class="mb-3 row">
                                            <div class="offset-sm-3 col-sm-9">
                                                <button type="submit" class="btn btn-success"><i class="bi bi-save"></i>Lưu
                                                    thay đổi</button>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="tab-pane fade" id="changePassword" role="tabpanel"
                                    ...
                                    <form class="form-horizontal" action="{{ route('admin.profile.changePassword') }}"
                                        ...
                                        <div class="mb-3 row">
                                            <label for="current_password" class="col-sm-4 col-form-label">Mật khẩu hiện tại
                                        ...
                                        <div class="mb-3 row">
                                            <label for="new_password_confirmation" class="col-sm-4 col-form-label">Xác nhận
