            ...
            <div class="modal-body">
                <form id="updateOrderForm" method="POST">
                    ...
                    <div class="order-summary-details text-end">
                        <p class="mb-1"><strong>Tổng phụ:</strong> <span id="update-order-subtotal"></span></p>
                        <p class="mb-1"><strong>Phí vận chuyển:</strong> <span id="update-order-shipping-fee"></span>
                        </p>
                        <p class="mb-1 text-success"><strong>Giảm giá:</strong> <span id="update-order-discount"></span>
                        </p>
