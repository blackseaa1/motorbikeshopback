    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-lg-8 border-end pe-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="customer_type" id="customerTypeExisting" value="existing" checked>
                            ...
                            <div id="existingCustomerBlock">
                                <div class="mb-3">
                                    <label for="customer_id_create" class="form-label">Chọn khách hàng <span class="text-danger">*</span></label>
                                    <select class="form-select selectpicker" id="customer_id_create" name="customer_id" data-live-search="true" title="Tìm và chọn khách hàng...">
                                        @foreach($customers as $customer)
                                            <option value="{{ $customer->id }}" data-subtext="{{ $customer->email }}">{{ $customer->name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <input type="hidden" name="shipping_address_option" id="shipping_address_option_create" value="existing">

                            <div id="existingAddressBlock">
                                <div id="addressListContainer" class="address-list-container mb-2 p-3 border rounded bg-light" style="max-height: 200px; overflow-y: auto;">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-primary" id="btn-show-new-address-form">
                            ...
                            <div id="newAddressBlock" class="d-none">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="new_shipping_name" class="form-label">Họ tên người nhận <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="new_shipping_name" name="new_shipping_name">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="new_shipping_phone" class="form-label">SĐT người nhận <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="new_shipping_phone" name="new_shipping_phone">
                                    </div>
                                    <div class="col-md-6 mb-3 guest-only-field" style="display: none;">
                                        <label for="guest_name" class="form-label">Họ tên khách vãng lai <span class="text-danger">*</span></label>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        <label for="new_province_id" class="form-label">Tỉnh/Thành <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-select" id="new_district_id" name="new_district_id" disabled>
                                ...
                                <div class="mb-3">
                                    <label for="new_address_line" class="form-label">Địa chỉ cụ thể <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="new_address_line" name="new_address_line">
                                </div>
                                <button type="button" class="btn btn-sm btn-link ps-0" id="btn-cancel-new-address">Hủy và chọn địa chỉ có sẵn</button>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="p-3 bg-light rounded sticky-top" style="top: 1rem;">
                                ...
                                <div class="mb-3">
                                    <label for="delivery_service_id_create" class="form-label">ĐV Vận chuyển <span class="text-danger">*</span></label>
                                    <select class="form-select" id="delivery_service_id_create" name="delivery_service_id">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="promotion_id_create" name="promotion_id">
                                        ...
                                        @foreach($promotions as $promo)
                                            <option value="{{ $promo->id }}" data-type="{{ $promo->type }}" data-value="{{ $promo->value }}">{{ $promo->code }} - {{ $promo->description }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3">
                                    <label for="status_create" class="form-label">Trạng thái <span class="text-danger">*</span></label>
                                ...
                                <div id="orderSummary" class="order-summary-details">
                                    <p class="mb-2 d-flex justify-content-between"><span>Tổng phụ:</span> <span id="summary-subtotal">0 ₫</span></p>
                                    <p class="mb-2 d-flex justify-content-between"><span>Phí vận chuyển:</span> <span id="summary-shipping">0 ₫</span></p>
                                    <p class="mb-2 d-flex justify-content-between text-success"><span>Giảm giá:</span> <span id="summary-discount">-0 ₫</span></p>
                                    <hr class="my-2">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="createOrderForm" class="btn btn-primary"><i class="bi bi-save me-2"></i>Tạo đơn hàng</button>
            </div>
        </div>
    </div>
</div>
