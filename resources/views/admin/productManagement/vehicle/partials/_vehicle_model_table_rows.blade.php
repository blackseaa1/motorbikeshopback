{{-- File này chứa các hàng của bảng Dòng xe, được include từ vehicles.blade.php hoặc VehicleModelController cho AJAX. --}}
    ...
    <tr id="vehicle-model-row-{{ $model->id }}"
        ...
        <td class="text-center action-buttons">
            <div class="d-flex justify-content-center">
                ...
                <button type="button"
                    class="btn btn-sm toggle-status-model-btn {{ $model->isActive() ? 'btn-outline-secondary' : 'btn-danger' }} me-2" {{-- ID riêng --}}
                    data-id="{{ $model->id }}"
...
@empty
    <tr id="no-vehicle-models-row">
        <td colspan="8" class="text-center"> {{-- Cập nhật colspan cho đúng số cột --}}
