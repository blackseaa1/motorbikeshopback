...
<div class="modal fade" id="bulkToggleStatusModal" tabindex="-1" aria-labelledby="bulkToggleStatusModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="bulkToggleStatusForm" action="{{ route('admin.productManagement.categories.bulkToggleStatus') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    <p>Bạn muốn chuyển trạng thái của <strong id="selectedCountToggleModal">0</strong> danh mục đã chọn thành gì?</p>
                    <div class="mb-3">
